...
class Agent:
    ...
    def get_state(self, game):
        ...
        # Các biến này chưa dùng, có thể xoá nếu không cần
        # obs_1 = game.car_obs_rec_1
        # obs_2 = game.car_obs_rec_2
        # obs_3 = game.car_obs_rec_3
...
from Cargame_AI import CarGameAI, Direction
from model import Linear_QNet, QTrainer
from helper import plot, plot_eval   # thêm plot_eval
...
def train():
    ...
    # Đánh giá agent
    evaluate(agent, n_games=50, render=False)
